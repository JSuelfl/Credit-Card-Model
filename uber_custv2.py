...
Use_Case = [40,41]*2 + [1,4,7,10,13,16,19,22,25,28,31,34,39]*4 + [2,5,8,11,14,17,20,23,26,29,32,35,38]*7 + [3,6,9,12,15,18,24,27,30,33,36]*65 + [37]*73
...
#Creates CSV
with open('uber_custv2.csv','w') as f1:
