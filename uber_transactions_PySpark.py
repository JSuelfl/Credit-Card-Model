...
def gen_tran(MCC_credits,MCC_debits,Tran_Country_Credits,Tran_Country_Debits,Tran_Type_C,Tran_Type_D,Upper_Limit,Delta,trans_no,j,use_case,risk_color,risk_num):
    liCustTrans = []
    ...
    for k in xrange(NoTrans):
        ...
        CCTypes[j],use_case,risk_color,risk_num,Holders[j],CCsCount[j],Cities[j],States[j],ZIPs[j],Countries[j]])
        trans_no += 1
        transDetail=''
    ...
    if Balance < 0:
        ...
        use_case,risk_color,risk_num,Holders[j],CCsCount[j],Cities[j],States[j],ZIPs[j],Countries[j],''])
    elif Balance > 0:
        postedDate = maxDate+tdelta
        maxDate = postedDate
        #date of transaction a day later
        ...
        row.extend([postedDate, transDate, 'Payment','C',limit,Balance,0,CCs[j],CCTypes[j],use_case,risk_color,risk_num,
...
def createTransData(ccount, remainder, lenI, iterator):
    ...
    for i in x:
        if(ClsdFlags[i]=='No'):
            ...
            #Red Risk
            if(UseCase[i]=='1'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Ovpmt_Refund,Transaction_Typev2.Debit_Ovpmt_Red,3,-1,trans_no,i,1.0,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='2'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Ovpmt_Refund,Transaction_Typev2.Debit_Ovpmt_Yellow,4,-2,trans_no,i,1.0,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='3'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Ovpmt_Refund,Transaction_Typev2.Debit_Ovpmt_Green,5,-3,trans_no,i,1.0,'Green',1))

            #Use Case 1.1: Threshold for refunds
            #Red Risk
            elif(UseCase[i]=='4'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Refund_Red,Transaction_Typev2.Debit_Refund,3,-1,trans_no,i,1.1,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='5'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Refund_Yellow,Transaction_Typev2.Debit_Refund,3,-1,trans_no,i,1.1,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='6'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Refund_Green,Transaction_Typev2.Debit_Refund,3,-1,trans_no,i,1.1,'Green',1))

            #Use Case 2: Method of payment to card balances
            #Red Risk
            elif(UseCase[i]=='7'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Payments_Red,Transaction_Typev2.Debit_Payments_Red,3,-1,trans_no,i,2,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='8'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Payments_Yellow,Transaction_Typev2.Debit_Payments_Yellow,3,-1,trans_no,i,2,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='9'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Payments_Green,Transaction_Typev2.Debit_Payments_Green,3,-1,trans_no,i,2,'Green',1))

            #Use Case 3: Payment source is owned by non-account holder
            #Red Risk
            elif(UseCase[i]=='10'):
                liTrans.extend(gen_tran(Account_Holder_Type_Red,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_10_41No19_21No25_27,Transaction_Typev2.Debit_10_41No19_21No25_27,4,-2,trans_no,i,3,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='11'):
                liTrans.extend(gen_tran(Account_Holder_Type_Yellow,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_10_41No19_21No25_27,Transaction_Typev2.Debit_10_41No19_21No25_27,4,-2,trans_no,i,3,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='12'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_10_41No19_21No25_27,Transaction_Typev2.Debit_10_41No19_21No25_27,3,-1,trans_no,i,3,'Green',1))

            #Use Case 4: Payment is frequently made at a location that is materially distant from the account address
            #Red Risk
            elif(UseCase[i]=='13'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,Payment_DistLoc_Red,['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,4,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='14'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,Payment_DistLoc_Yellow,['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,4,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='15'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,Payment_DistLoc_Green,['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,4,'Green',1))

            #Use Case 5: Frequent or large transactions at high-risk countries
            #Red Risk
            elif(UseCase[i]=='16'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],High_Risk_Countries_Red,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,5,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='17'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],High_Risk_Countries_Yellow,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,5,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='18'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],High_Risk_Countries_Green,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,5,'Green',1))

            #Use Case 6: Usual ATM withdrawals for cash advance
            #Red Risk
            elif(UseCase[i]=='19'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_ATM,Transaction_Typev2.Debit_ATM_Red,3,-1,trans_no,i,6,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='20'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_ATM,Transaction_Typev2.Debit_ATM_Yellow,3,-1,trans_no,i,6,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='21'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_ATM,Transaction_Typev2.Debit_ATM_Green,3,-1,trans_no,i,6,'Green',1))

            #Use Case 7: Frequent Credit Card transactions at locations "materially distant" from the account address
            #Red Risk
            elif(UseCase[i]=='22'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.Red,Transaction_DistLoc.Red,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,7,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='23'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.Yellow,Transaction_DistLoc.Yellow,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,7,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='24'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.Green,Transaction_DistLoc.Green,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,7,'Green',1))

            #Use Case 8: Merchant credits without offseting merchant transactions
            #Red Risk
            elif(UseCase[i]=='25'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Merchant_Credits_Red,Transaction_Typev2.Merchant_Debit,3,-1,trans_no,i,8,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='26'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Merchant_Credits_Yellow,Transaction_Typev2.Merchant_Debit,3,-1,trans_no,i,8,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='27'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Merchant_Credits_Green,Transaction_Typev2.Merchant_Debit,3,-1,trans_no,i,8,'Green',1))

            #Use Case 9: Hotel room rentals at different hotels over the same time period
            #Red Risk
            elif(UseCase[i]=='28'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Hotels.Red,['US'],['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,4,-2,trans_no,i,9,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='29'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Hotels.Yellow,['US'],['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,4,-2,trans_no,i,9,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='30'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Hotels.Green,['US'],['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,4,-2,trans_no,i,9,'Green',1))

            #Use Case 10: Multiple airline tickets for non-account holders
            #Red Risk
            elif(UseCase[i]=='31'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Airlines.Red,['US'],['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,4,-2,trans_no,i,10,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='32'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Airlines.Yellow,['US'],['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,4,-2,trans_no,i,10,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='33'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Airlines.Green,['US'],['US'],Transaction_Typev2.Payments,Transaction_Typev2.Debit,4,-2,trans_no,i,10,'Green',1))

            #Use Case 11: Unusually large payments for accumulated balances
            #Red Risk
            elif(UseCase[i]=='34'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Ovpmt_Refund,Transaction_Typev2.Debit_Ovpmt_Red,6,-4,trans_no,i,11,'Red',3))
            #Yellow Risk
            elif(UseCase[i]=='35'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Ovpmt_Refund,Transaction_Typev2.Debit_Ovpmt_Yellow,5,-3,trans_no,i,11,'Yellow',2))
            #Green Risk
            elif(UseCase[i]=='36'):
                liTrans.extend(gen_tran(['1111'],Merchant_Category.Green,['US'],['US'],Transaction_Typev2.Credits_Ovpmt_Refund,Transaction_Typev2.Debit_Ovpmt_Green,4,-2,trans_no,i,11,'Green',1))

            #Use Case 12: Custom out of country scenario
            elif(UseCase[i]=='37'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.OutofCountry_100,Transaction_DistLoc.OutofCountry_100,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,12,'Out of Country - US',4))
            elif(UseCase[i]=='38'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.OutofCountry_95,Transaction_DistLoc.OutofCountry_95,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,12,'Out of Country - 95',5))
            elif(UseCase[i]=='39'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.OutofCountry_50,Transaction_DistLoc.OutofCountry_50,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,12,'Out of Country - 50',6))
            elif(UseCase[i]=='40'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.OutofCountry_40,Transaction_DistLoc.OutofCountry_40,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,12,'Out of Country - 40',7))
            elif(UseCase[i]=='41'):
                liTrans.extend(gen_tran(Account_Holder_Type_Green,Merchant_Category.Green,Transaction_DistLoc.OutofCountry_10,Transaction_DistLoc.OutofCountry_10,Transaction_Typev2.Payments,Transaction_Typev2.Debit,3,-1,trans_no,i,12,'Out of Country - 10',8))
    return liTrans
